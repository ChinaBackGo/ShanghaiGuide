...
public class PlaceDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + PlacePersistenceContract.PlaceEntry.TABLE_NAME + " (" +
                    ...
                    PlacePersistenceContract.PlaceEntry.COLUMN_NAME_CATEGORY + INTEGER_TYPE + COMMA_SEP +
    ...
    private static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + PlacePersistenceContract.PlaceEntry.TABLE_NAME;
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // TODO: update schema change properly, this just nukes everything.
